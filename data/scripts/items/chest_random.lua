...
--03/03/2024 Conga: Since there's no system for deleting old files in TI, this file can't be removed to allow automatic compatibility with future noita updates and mods.
--As such, please remember to manually update this every time a major change to the chest loot pool comes around, or whenever you feel like it.
--If you're a modder in the far future with free time and expertse, maybe you could find a way to purge this file for good?
