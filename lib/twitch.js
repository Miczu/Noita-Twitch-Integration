...
class Twitch {
    constructor(parent) {
        ...
        this.client.connect().catch(err => {
            console.error('-------------------------------------------------------------------');
            console.error('[Twitch Connection Error] Failed to connect to Twitch chat.');
            console.error('This is often caused by an outdated component.');
            console.error('Please close this window and run "install.bat" to update it.');
            console.error('If the problem continues, also verify your channel name in the Web UI.');
            console.error('-------------------------------------------------------------------');
        });
        this.init()
    }
